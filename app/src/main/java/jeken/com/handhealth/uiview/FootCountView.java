package jeken.com.handhealth.uiview;
 ...
 */
public class FootCountView extends View {
    ...
    private String mHeaderText = "步数";//"km/h"; // 表头
    ...
    public FootCountView(Context context) {
        this(context, null);
    }

    public FootCountView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FootCountView(Context context, AttributeSet attrs, int defStyleAttr) {
