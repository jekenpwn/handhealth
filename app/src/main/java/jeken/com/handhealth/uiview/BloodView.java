...
public class BloodView extends View {
    ...
    private int mMin = 10; // 最小值
    private int mMax = 200; // 最大值
    private String mHeaderText = "血压"; // 表头
    private int mCreditValue = 70; // 信用分
    ...
    public void setBloodFlag(boolean isLow){
        this.isLow = isLow;
        if (isLow){
            mHeaderText="舒张血压";
        }else{
...
//        }
       if (!isLow){
           if (mCreditValue>=140){
               return "血压高";
           }else if (mCreditValue<140 && mCreditValue>90){
               return "血压正常";
           }else {
               return "血压低";
           }
           ...
           if (mCreditValue>=90){
               return "血压高";
           }else if (mCreditValue<90 && mCreditValue>60){
               return "血压正常";
           }else {
               return "血压低";
           }
