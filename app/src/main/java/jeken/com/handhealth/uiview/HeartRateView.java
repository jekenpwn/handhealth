...
public class HeartRateView extends View {
    ...
    private int mMax = 255; // 最大值
    private int mSection = 10; // 值域（mMax-mMin）等分份数
    private int mPortion = 3; // 一个mSection等分份数
    private String mHeaderText = "心率"; // 表头
    private int mCreditValue = 60; // 信用分
...
//            return "心率中等";
//        }
        if (mSolidCreditValue >= 110){
            return "心率过高";
        }else if (mSolidCreditValue <110 && mSolidCreditValue<=60){
            return "心率正常";
