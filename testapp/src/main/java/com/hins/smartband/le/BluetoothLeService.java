...
public class BluetoothLeService extends Service {
    ...
    public final static String DEVICE_TWO_ADDRESS =
            "com.example.bluetooth.le.DEVICE_TWO_ADDRESS";
    public final static String ACTION_GATT_WRITE=
            "com.example.bluetooth.le.ACTION_GATT_WRITE";
                ...
                for(BluetoothGattService gattService : gatt.getServices()){
                    ...
                    for(BluetoothGattCharacteristic gattCharacteristic : gattService.getCharacteristics()){
                        ...
                        if(uuid.equals("0000ffe1-0000-1000-8000-00805f9b34fb")){
                            BluetoothGattCharacteristic A=new BluetoothGattCharacteristic(UUID.fromString(uuid), BluetoothGattCharacteristic.PROPERTY_WRITE|
                            ...
                            gatt.setCharacteristicNotification(A,true);
                            //======================================
...
//        } else {
        ...
        if (data != null && data.length > 0) {
            final StringBuffer stringBuilder = new StringBuffer(data.length);
