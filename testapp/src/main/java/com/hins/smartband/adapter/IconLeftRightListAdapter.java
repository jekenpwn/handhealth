 ...
 * 描述：
 */
public class IconLeftRightListAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<IconLeftRightListBean> datas;

    public IconLeftRightListAdapter(Context context, ArrayList<IconLeftRightListBean> iconleftRightBean) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_icon_left_right_list, parent, false);
